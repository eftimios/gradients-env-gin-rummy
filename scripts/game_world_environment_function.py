...
def rollout_last_prompt_and_completion_parallelized_curriculum(
    ...
    def run_single_prompt(index: int, prompt: str):
        ...
        # For Gin Rummy, we don't have a simple strategy check like Goofspiel
        # Strategy success is determined by final game outcome
...
def rollout_full_prompt_and_completion_parallelized_curriculum(
    ...
    def run_single_prompt(index: int, prompt: str):
        ...
        while not done and (turn_number < current_max_turn):
            ...
            # For Gin Rummy, we don't have a simple strategy check like Goofspiel
            # Strategy success is determined by final game outcome
            # No immediate rewards for strategy adherence
        ...
        # For Gin Rummy, no strategy adherence (complex game)
        strategy_ratio = 0.0
